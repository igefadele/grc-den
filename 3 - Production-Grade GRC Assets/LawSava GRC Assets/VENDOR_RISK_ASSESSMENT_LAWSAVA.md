# LawSava Vendor Risk Assessment Questionnaire & Scorecard

**Target Vendor Entity:** [Insert Third-Party Vendor Name]  
**Functional System Scope:** [e.g., Cloud Storage Provider, SMS Alert Ingestor]  
**Reviewing Coordinator:** LawSava Technical GRC Unit  
...
### Section C: Operations & Product Security
* **Q5:** Detail your Secure Software Development Lifecycle (SDLC) verification standards. Do you run automated vulnerability testing pipelines (SAST/DAST) prior to code production deployment?
* **Q6:** Outline your internal developer corporate onboarding and access termination policies. Are corporate sessions required to pass mandatory Multi-Factor Authentication?
...
| :--- | :--- | :--- | :--- | :--- |
| **Framework Maturity** | Validated SOC 2 Type II / HIPAA artifact covering current scope. | 5 | | |
...
| **Data Sovereignty Compliance**| Matches regional isolation requirements for data residency. | 5 | | |
