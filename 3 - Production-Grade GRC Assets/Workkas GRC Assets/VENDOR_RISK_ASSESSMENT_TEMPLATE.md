# Workkas Vendor Risk Assessment Questionnaire & Scorecard

**Target Vendor Entity:** [Insert Third-Party Vendor Name - e.g., Cross-Border Payment Engine, Global KYC Provider]  
**Functional System Scope:** [e.g., International Wire Gateway, Visa/Passport Verification API]  
**Reviewing Coordinator:** Workkas Technical GRC Unit  
...
### Section C: Cross-Border & Regulatory Compliance
* **Q5:** Detail your infrastructure alignment with cross-border data protection constraints (e.g., GDPR data transfers, regional data storage boundaries).
* **Q6:** Outline your business continuation and disaster recovery configurations designed to maintain uptime across international processing networks during infrastructure outages.
...
| **Regulatory Alignment** | Full compliance documentation for cross-border data routing. | 5 | | |
